-- Migration: Create Complete MCS Schema
-- Purpose: Define PostgreSQL enum types, tables, and functions for the clinic management system
-- Version: v2_P01_001
-- Created: 2026-03-04
-- Dependencies: None

-- Drop and recreate public schema to ensure clean, idempotent migration
...
-- Create auth schema (used for Supabase and RLS policies)
-- This schema is required for compatibility with Supabase RLS policies
...
-- (Disabled: requires Supabase auth.role() function)
...
COMMENT ON COLUMN countries.currency_symbol IS 'Currency symbol (e.g., $, ??)';
...
('Algeria', '???????', 'DZ', 'DZA', 12, '+213', 'DZD', 'Algerian Dinar', '????? ??????', '??', 'Africa', 'Africa', 'Northern Africa', 'Algiers', '???????'),

-- Other Arab countries
('Morocco', '??????', 'MA', 'MAR', 504, '+212', 'MAD', 'Moroccan Dirham', '???? ?????', 'DH', 'Africa', 'Africa', 'Northern Africa', 'Rabat', '??????'),
('Tunisia', '????', 'TN', 'TUN', 788, '+216', 'TND', 'Tunisian Dinar', '????? ?????', 'DT', 'Africa', 'Africa', 'Northern Africa', 'Tunis', '????'),
('Egypt', '???', 'EG', 'EGY', 818, '+20', 'EGP', 'Egyptian Pound', '???? ????', 'E£', 'Africa', 'Africa', 'Northern Africa', 'Cairo', '???????'),
('Saudi Arabia', '??????? ??????? ????????', 'SA', 'SAU', 682, '+966', 'SAR', 'Saudi Riyal', '???? ?????', '?.?', 'Asia', 'Asia', 'Western Asia', 'Riyadh', '??????'),
('United Arab Emirates', '???????? ??????? ???????', 'AE', 'ARE', 784, '+971', 'AED', 'UAE Dirham', '???? ???????', 'DH', 'Asia', 'Asia', 'Western Asia', 'Abu Dhabi', '??? ???'),
('Qatar', '???', 'QA', 'QAT', 634, '+974', 'QAR', 'Qatari Riyal', '???? ????', '?.?', 'Asia', 'Asia', 'Western Asia', 'Doha', '??????'),
('Kuwait', '??????', 'KW', 'KWT', 414, '+965', 'KWD', 'Kuwaiti Dinar', '????? ?????', '?.?', 'Asia', 'Asia', 'Western Asia', 'Kuwait City', '????? ??????'),

-- Major countries
('United States', '???????? ???????', 'US', 'USA', 840, '+1', 'USD', 'US Dollar', '????? ??????', '$', 'North America', 'Americas', 'Northern America', 'Washington, D.C.', '?????? ???????'),
('United Kingdom', '??????? ???????', 'GB', 'GBR', 826, '+44', 'GBP', 'British Pound', '???? ????????', '£', 'Europe', 'Europe', 'Northern Europe', 'London', '????'),
('France', '?????', 'FR', 'FRA', 250, '+33', 'EUR', 'Euro', '????', '€', 'Europe', 'Europe', 'Western Europe', 'Paris', '?????'),
('Germany', '???????', 'DE', 'DEU', 276, '+49', 'EUR', 'Euro', '????', '€', 'Europe', 'Europe', 'Western Europe', 'Berlin', '?????'),
('Canada', '????', 'CA', 'CAN', 124, '+1', 'CAD', 'Canadian Dollar', '????? ????', '$', 'North America', 'Americas', 'Northern America', 'Ottawa', '??????'),
('Australia', '????????', 'AU', 'AUS', 36, '+61', 'AUD', 'Australian Dollar', '????? ???????', '$', 'Oceania', 'Oceania', 'Australia and New Zealand', 'Canberra', '???????'),
('Japan', '???????', 'JP', 'JPN', 392, '+81', 'JPY', 'Japanese Yen', '?? ??????', '¥', 'Asia', 'Asia', 'Eastern Asia', 'Tokyo', '?????'),
('China', '?????', 'CN', 'CHN', 156, '+86', 'CNY', 'Chinese Yuan', '???? ????', '¥', 'Asia', 'Asia', 'Eastern Asia', 'Beijing', '????'),
('India', '?????', 'IN', 'IND', 356, '+91', 'INR', 'Indian Rupee', '????? ?????', '?', 'Asia', 'Asia', 'Southern Asia', 'New Delhi', '???????'),
('Brazil', '????????', 'BR', 'BRA', 76, '+55', 'BRL', 'Brazilian Real', '???? ???????', 'R$', 'South America', 'Americas', 'South America', 'Brasília', '????????'),
('Russia', '?????', 'RU', 'RUS', 643, '+7', 'RUB', 'Russian Ruble', '???? ????', '?', 'Europe', 'Europe', 'Eastern Europe', 'Moscow', '?????'),
('Turkey', '?????', 'TR', 'TUR', 792, '+90', 'TRY', 'Turkish Lira', '???? ?????', '?', 'Europe', 'Asia', 'Western Asia', 'Ankara', '?????'),
('Spain', '???????', 'ES', 'ESP', 724, '+34', 'EUR', 'Euro', '????', '€', 'Europe', 'Europe', 'Southern Europe', 'Madrid', '?????'),
('Italy', '???????', 'IT', 'ITA', 380, '+39', 'EUR', 'Euro', '????', '€', 'Europe', 'Europe', 'Southern Europe', 'Rome', '????'),
('Netherlands', '??????', 'NL', 'NLD', 528, '+31', 'EUR', 'Euro', '????', '€', 'Europe', 'Europe', 'Western Europe', 'Amsterdam', '????????'),
('Belgium', '??????', 'BE', 'BEL', 56, '+32', 'EUR', 'Euro', '????', '€', 'Europe', 'Europe', 'Western Europe', 'Brussels', '??????'),
('Switzerland', '??????', 'CH', 'CHE', 756, '+41', 'CHF', 'Swiss Franc', '???? ??????', 'CHF', 'Europe', 'Europe', 'Western Europe', 'Bern', '???'),
('Sweden', '??????', 'SE', 'SWE', 752, '+46', 'SEK', 'Swedish Krona', '????? ??????', 'kr', 'Europe', 'Europe', 'Northern Europe', 'Stockholm', '????????'),
('Norway', '???????', 'NO', 'NOR', 578, '+47', 'NOK', 'Norwegian Krone', '????? ???????', 'kr', 'Europe', 'Europe', 'Northern Europe', 'Oslo', '?????'),
('Denmark', '????????', 'DK', 'DNK', 208, '+45', 'DKK', 'Danish Krone', '????? ????????', 'kr', 'Europe', 'Europe', 'Northern Europe', 'Copenhagen', '????????'),
('Finland', '??????', 'FI', 'FIN', 246, '+358', 'EUR', 'Euro', '????', '€', 'Europe', 'Europe', 'Northern Europe', 'Helsinki', '??????'),
('Poland', '??????', 'PL', 'POL', 616, '+48', 'PLN', 'Polish Zloty', '????? ??????', 'z?', 'Europe', 'Europe', 'Eastern Europe', 'Warsaw', '?????'),
('South Korea', '????? ????????', 'KR', 'KOR', 410, '+82', 'KRW', 'South Korean Won', '??? ???? ?????', '?', 'Asia', 'Asia', 'Eastern Asia', 'Seoul', '???'),
('Singapore', '????????', 'SG', 'SGP', 702, '+65', 'SGD', 'Singapore Dollar', '????? ????????', '$', 'Asia', 'Asia', 'South-Eastern Asia', 'Singapore', '????????'),
('Malaysia', '???????', 'MY', 'MYS', 458, '+60', 'MYR', 'Malaysian Ringgit', '?????? ??????', 'RM', 'Asia', 'Asia', 'South-Eastern Asia', 'Kuala Lumpur', '??????????'),
('Indonesia', '?????????', 'ID', 'IDN', 360, '+62', 'IDR', 'Indonesian Rupiah', '????? ?????????', 'Rp', 'Asia', 'Asia', 'South-Eastern Asia', 'Jakarta', '??????'),
('Thailand', '???????', 'TH', 'THA', 764, '+66', 'THB', 'Thai Baht', '??? ???????', '?', 'Asia', 'Asia', 'South-Eastern Asia', 'Bangkok', '??????'),
('Vietnam', '??????', 'VN', 'VNM', 704, '+84', 'VND', 'Vietnamese Dong', '???? ???????', '?', 'Asia', 'Asia', 'South-Eastern Asia', 'Hanoi', '?????'),
('Philippines', '???????', 'PH', 'PHL', 608, '+63', 'PHP', 'Philippine Peso', '???? ??????', '?', 'Asia', 'Asia', 'South-Eastern Asia', 'Manila', '??????'),
('Pakistan', '???????', 'PK', 'PAK', 586, '+92', 'PKR', 'Pakistani Rupee', '????? ?????????', '?', 'Asia', 'Asia', 'Southern Asia', 'Islamabad', '????? ????'),
('Bangladesh', '????????', 'BD', 'BGD', 50, '+880', 'BDT', 'Bangladeshi Taka', '???? ?????????', '?', 'Asia', 'Asia', 'Southern Asia', 'Dhaka', '???'),
('Nigeria', '???????', 'NG', 'NGA', 566, '+234', 'NGN', 'Nigerian Naira', '????? ??????', '?', 'Africa', 'Africa', 'Western Africa', 'Abuja', '?????'),
('South Africa', '???? ???????', 'ZA', 'ZAF', 710, '+27', 'ZAR', 'South African Rand', '???? ???? ??????', 'R', 'Africa', 'Africa', 'Southern Africa', 'Pretoria', '????????'),
('Mexico', '???????', 'MX', 'MEX', 484, '+52', 'MXN', 'Mexican Peso', '???? ??????', '$', 'North America', 'Americas', 'Northern America', 'Mexico City', '????? ??????'),
('Argentina', '?????????', 'AR', 'ARG', 32, '+54', 'ARS', 'Argentine Peso', '???? ????????', '$', 'South America', 'Americas', 'South America', 'Buenos Aires', '????? ????'),
('Colombia', '????????', 'CO', 'COL', 170, '+57', 'COP', 'Colombian Peso', '???? ???????', '$', 'South America', 'Americas', 'South America', 'Bogotá', '??????'),
('Chile', '?????', 'CL', 'CHL', 152, '+56', 'CLP', 'Chilean Peso', '???? ?????', '$', 'South America', 'Americas', 'South America', 'Santiago', '????????'),
('Peru', '????', 'PE', 'PER', 604, '+51', 'PEN', 'Peruvian Sol', '??? ??????', 'S/.', 'South America', 'Americas', 'South America', 'Lima', '????'),
('Venezuela', '???????', 'VE', 'VEN', 862, '+58', 'VES', 'Venezuelan Bolívar', '??????? ???????', 'Bs.', 'South America', 'Americas', 'South America', 'Caracas', '???????'),
('Greece', '???????', 'GR', 'GRC', 300, '+30', 'EUR', 'Euro', '????', '€', 'Europe', 'Europe', 'Southern Europe', 'Athens', '?????'),
('Portugal', '????????', 'PT', 'PRT', 620, '+351', 'EUR', 'Euro', '????', '€', 'Europe', 'Europe', 'Southern Europe', 'Lisbon', '??????'),
('Ireland', '???????', 'IE', 'IRL', 372, '+353', 'EUR', 'Euro', '????', '€', 'Europe', 'Europe', 'Northern Europe', 'Dublin', '????'),
('New Zealand', '?????????', 'NZ', 'NZL', 554, '+64', 'NZD', 'New Zealand Dollar', '????? ?????????', '$', 'Oceania', 'Oceania', 'Australia and New Zealand', 'Wellington', '?????????'),
('South Sudan', '???? ???????', 'SS', 'SSD', 728, '+211', 'SSP', 'South Sudanese Pound', '???? ???? ??????', '£', 'Africa', 'Africa', 'Northern Africa', 'Juba', '????'),
('Libya', '?????', 'LY', 'LBY', 434, '+218', 'LYD', 'Libyan Dinar', '????? ????', '?.?', 'Africa', 'Africa', 'Northern Africa', 'Tripoli', '??????'),
('Jordan', '??????', 'JO', 'JOR', 400, '+962', 'JOD', 'Jordanian Dinar', '????? ?????', '?.?', 'Asia', 'Asia', 'Western Asia', 'Amman', '????'),
('Lebanon', '?????', 'LB', 'LBN', 422, '+961', 'LBP', 'Lebanese Pound', '???? ???????', '?.?', 'Asia', 'Asia', 'Western Asia', 'Beirut', '?????'),
('Syria', '?????', 'SY', 'SYR', 760, '+963', 'SYP', 'Syrian Pound', '???? ?????', '?.?', 'Asia', 'Asia', 'Western Asia', 'Damascus', '????'),
('Iraq', '??????', 'IQ', 'IRQ', 368, '+964', 'IQD', 'Iraqi Dinar', '????? ?????', '?.?', 'Asia', 'Asia', 'Western Asia', 'Baghdad', '?????'),
('Yemen', '?????', 'YE', 'YEM', 887, '+967', 'YER', 'Yemeni Rial', '???? ????', '?.?', 'Asia', 'Asia', 'Western Asia', 'Sana''a', '?????'),
('Oman', '????', 'OM', 'OMN', 512, '+968', 'OMR', 'Omani Rial', '???? ?????', '?.?', 'Asia', 'Asia', 'Western Asia', 'Muscat', '????'),
('Bahrain', '???????', 'BH', 'BHR', 48, '+973', 'BHD', 'Bahraini Dinar', '????? ??????', '?.?', 'Asia', 'Asia', 'Western Asia', 'Manama', '???????'),
('Palestine', '??????', 'PS', 'PSE', 275, '+970', 'PSE', 'Palestini New Shekel', '???? ??????? ????', '?', 'Asia', 'Asia', 'Western Asia', 'Ramallah', '??? ????')
...
(
  ...
  'Adrar', '?????', '01', 'DZ-01', 'Wilaya', 'Adrar', '?????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Chlef', '?????', '02', 'DZ-02', 'Wilaya', 'Chlef', '?????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Laghouat', '???????', '03', 'DZ-03', 'Wilaya', 'Laghouat', '???????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Oum El Bouaghi', '?? ???????', '04', 'DZ-04', 'Wilaya', 'Oum El Bouaghi', '?? ???????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Batna', '?????', '05', 'DZ-05', 'Wilaya', 'Batna', '?????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Béjaïa', '?????', '06', 'DZ-06', 'Wilaya', 'Béjaïa', '?????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Biskra', '?????', '07', 'DZ-07', 'Wilaya', 'Biskra', '?????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Béchar', '????', '08', 'DZ-08', 'Wilaya', 'Béchar', '????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Blida', '???????', '09', 'DZ-09', 'Wilaya', 'Blida', '???????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Bouira', '???????', '10', 'DZ-10', 'Wilaya', 'Bouira', '???????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Tamanrasset', '???????', '11', 'DZ-11', 'Wilaya', 'Tamanrasset', '???????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Tébessa', '????', '12', 'DZ-12', 'Wilaya', 'Tébessa', '????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Tlemcen', '??????', '13', 'DZ-13', 'Wilaya', 'Tlemcen', '??????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Tiaret', '?????', '14', 'DZ-14', 'Wilaya', 'Tiaret', '?????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Tizi Ouzou', '???? ???', '15', 'DZ-15', 'Wilaya', 'Tizi Ouzou', '???? ???', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Algiers', '???????', '16', 'DZ-16', 'Wilaya', 'Algiers', '???????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Djelfa', '??????', '17', 'DZ-17', 'Wilaya', 'Djelfa', '??????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Jijel', '????', '18', 'DZ-18', 'Wilaya', 'Jijel', '????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Sétif', '????', '19', 'DZ-19', 'Wilaya', 'Sétif', '????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Saïda', '?????', '20', 'DZ-20', 'Wilaya', 'Saïda', '?????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Skikda', '??????', '21', 'DZ-21', 'Wilaya', 'Skikda', '??????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Sidi Bel Abbès', '???? ??????', '22', 'DZ-22', 'Wilaya', 'Sidi Bel Abbès', '???? ??????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Annaba', '?????', '23', 'DZ-23', 'Wilaya', 'Annaba', '?????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Guelma', '?????', '24', 'DZ-24', 'Wilaya', 'Guelma', '?????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Constantine', '???????', '25', 'DZ-25', 'Wilaya', 'Constantine', '???????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Médéa', '??????', '26', 'DZ-26', 'Wilaya', 'Médéa', '??????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Mostaganem', '???????', '27', 'DZ-27', 'Wilaya', 'Mostaganem', '???????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'M''Sila', '???????', '28', 'DZ-28', 'Wilaya', 'M''Sila', '???????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Mascara', '?????', '29', 'DZ-29', 'Wilaya', 'Mascara', '?????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Ouargla', '?????', '30', 'DZ-30', 'Wilaya', 'Ouargla', '?????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Oran', '?????', '31', 'DZ-31', 'Wilaya', 'Oran', '?????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'El Bayadh', '?????', '32', 'DZ-32', 'Wilaya', 'El Bayadh', '?????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Illizi', '?????', '33', 'DZ-33', 'Wilaya', 'Illizi', '?????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Bordj Bou Arreridj', '??? ????????', '34', 'DZ-34', 'Wilaya', 'Bordj Bou Arreridj', '??? ????????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Boumerdès', '???????', '35', 'DZ-35', 'Wilaya', 'Boumerdès', '???????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'El Tarf', '??????', '36', 'DZ-36', 'Wilaya', 'El Tarf', '??????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Tindouf', '?????', '37', 'DZ-37', 'Wilaya', 'Tindouf', '?????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Tissemsilt', '????????', '38', 'DZ-38', 'Wilaya', 'Tissemsilt', '????????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'El Oued', '??????', '39', 'DZ-39', 'Wilaya', 'El Oued', '??????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Khenchela', '?????', '40', 'DZ-40', 'Wilaya', 'Khenchela', '?????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Souk Ahras', '??? ?????', '41', 'DZ-41', 'Wilaya', 'Souk Ahras', '??? ?????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Tipaza', '??????', '42', 'DZ-42', 'Wilaya', 'Tipaza', '??????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Mila', '????', '43', 'DZ-43', 'Wilaya', 'Mila', '????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Aïn Defla', '??? ??????', '44', 'DZ-44', 'Wilaya', 'Aïn Defla', '??? ??????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Naâma', '???????', '45', 'DZ-45', 'Wilaya', 'Naâma', '???????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Aïn Témouchent', '??? ??????', '46', 'DZ-46', 'Wilaya', 'Aïn Témouchent', '??? ??????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Ghardaïa', '??????', '47', 'DZ-47', 'Wilaya', 'Ghardaïa', '??????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Relizane', '??????', '48', 'DZ-48', 'Wilaya', 'Relizane', '??????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Timimoun', '???????', '49', 'DZ-49', 'Wilaya', 'Timimoun', '???????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Bordj Badji Mokhtar', '??? ???? ?????', '50', 'DZ-50', 'Wilaya', 'Bordj Badji Mokhtar', '??? ???? ?????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Ouled Djellal', '????? ????', '51', 'DZ-51', 'Wilaya', 'Ouled Djellal', '????? ????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Béni Abbès', '??? ????', '52', 'DZ-52', 'Wilaya', 'Béni Abbès', '??? ????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'In Salah', '??? ????', '53', 'DZ-53', 'Wilaya', 'In Salah', '??? ????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'In Guezzam', '??? ????', '54', 'DZ-54', 'Wilaya', 'In Guezzam', '??? ????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Touggourt', '????', '55', 'DZ-55', 'Wilaya', 'Touggourt', '????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'Djanet', '????', '56', 'DZ-56', 'Wilaya', 'Djanet', '????', true, true
),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'El M''Ghair', '??????', '57', 'DZ-57', 'Wilaya', 'El M''Ghair', '??????', true, true),
(
  (SELECT id FROM countries WHERE iso2_code = 'DZ'),
  'El Meniaa', '???????', '58', 'DZ-58', 'Wilaya', 'El Meniaa', '???????', true, true
);
...
-- ?? RLS DISABLED FOR POSTGRESQL COMPATIBILITY
...
('General Practice', '???? ?????', 'Comprehensive healthcare for individuals and families', '????? ???? ????? ??????? ?????????', 'medical_services', 1, 'Medical', true, true),
('Pediatrics', '?? ???????', 'Medical care for infants, children, and adolescents', '????? ???? ????? ???????? ??????????', 'child_care', 2, 'Medical', true, true),
('Internal Medicine', '???? ???????', 'Diagnosis and treatment of adult diseases', '????? ????? ????? ????????', 'medical_services', 3, 'Medical', true, true),
('Cardiology', '????? ?????', 'Diagnosis and treatment of heart diseases', '????? ????? ????? ?????', 'cardiology', 4, 'Medical', true, true),
('Dermatology', '??????? ???????', 'Treatment of skin, hair, and nail conditions', '???? ????? ????? ?????? ????????', 'dermatology', 5, 'Medical', true, true),
('Neurology', '???????', 'Diagnosis and treatment of nervous system disorders', '????? ????? ???????? ?????? ??????', 'neurology', 6, 'Medical', true, true),
('Orthopedics', '??????', 'Treatment of musculoskeletal system disorders', '???? ???????? ?????? ?????? ???????', 'orthopedics', 7, 'Medical', true, true),
('Ophthalmology', '?? ??????', 'Eye care and surgery', '????? ?????? ????????', 'ophthalmology', 8, 'Medical', true, true),
('Obstetrics and Gynecology', '????? ?????? ????????', 'Women''s reproductive health and childbirth', '????? ????????? ?????? ????????', 'pregnant_woman', 9, 'Medical', true, true),
('Psychiatry', '???? ??????', 'Mental health and behavioral disorders', '????? ??????? ??????????? ????????', 'psychology', 10, 'Medical', true, true),

-- Medical specialties
('Endocrinology', '????? ??????', 'Hormonal disorders and diabetes', '???????? ??????? ???????', 'medical_services', 11, 'Medical', true, false),
('Gastroenterology', '????? ?????? ??????', 'Digestive system disorders', '???????? ?????? ??????', 'medical_services', 12, 'Medical', true, false),
('Nephrology', '????? ?????', 'Kidney diseases and dialysis', '????? ????? ????? ?????', 'medical_services', 13, 'Medical', true, false),
('Pulmonology', '????? ?????', 'Respiratory system diseases', '????? ?????? ???????', 'medical_services', 14, 'Medical', true, false),
('Rheumatology', '????? ??????????', 'Autoimmune and rheumatic diseases', '????? ??????? ??????? ???????????', 'medical_services', 15, 'Medical', true, false),
('Hematology', '????? ????', 'Blood disorders and cancers', '????? ???? ??????????', 'medical_services', 16, 'Medical', true, false),
('Oncology', '???????', 'Cancer diagnosis and treatment', '????? ????? ???????', 'medical_services', 17, 'Medical', true, false),
('Infectious Diseases', '??????? ???????', 'Infections and tropical diseases', '?????? ???????? ??????????', 'medical_services', 18, 'Medical', true, false),
('Geriatrics', '?? ???????', 'Healthcare for elderly patients', '????? ???? ???????', 'medical_services', 19, 'Medical', true, false),
('Allergy and Immunology', '???????? ????????', 'Allergies and immune system disorders', '???????? ????????? ?????? ???????', 'medical_services', 20, 'Medical', true, false),

-- Surgical specialties
('General Surgery', '??????? ??????', 'Common surgical procedures', '????????? ???????? ???????', 'surgery', 21, 'Surgical', true, false),
('Neurosurgery', '????? ???? ????????', 'Brain and nervous system surgery', '????? ?????? ??????? ??????', 'neurosurgery', 22, 'Surgical', true, false),
('Cardiothoracic Surgery', '????? ????? ??????', 'Heart and chest surgery', '????? ????? ??????', 'cardiology', 23, 'Surgical', true, false),
('Vascular Surgery', '????? ??????? ???????', 'Blood vessel surgery', '????? ??????? ???????', 'vascular_surgery', 24, 'Surgical', true, false),
('Plastic Surgery', '??????? ?????????', 'Reconstructive and cosmetic surgery', '??????? ????????? ??????????', 'plastic_surgery', 25, 'Surgical', true, false),
('Pediatric Surgery', '????? ???????', 'Surgery for infants and children', '????? ????? ????????', 'surgery', 26, 'Surgical', true, false),
('Urology', '????? ??????? ???????', 'Urinary tract and male reproductive system', '??????? ??????? ??????? ???????? ??????', 'medical_services', 27, 'Surgical', true, false),
('Oral and Maxillofacial Surgery', '????? ???? ?????? ???????', 'Mouth, face, and jaw surgery', '????? ???? ?????? ???????', 'surgery', 28, 'Surgical', true, false),

-- Diagnostic specialties
('Radiology', '??????', 'Medical imaging and diagnosis', '??????? ????? ????????', 'radiology', 29, 'Diagnostic', true, false),
('Pathology', '??? ???????', 'Disease diagnosis through laboratory analysis', '????? ??????? ?? ???? ??????? ???????', 'medical_services', 30, 'Diagnostic', true, false),
('Clinical Pathology', '??? ??????? ???????', 'Laboratory medicine and diagnostics', '???? ??????? ????????', 'medical_services', 31, 'Diagnostic', true, false),
('Anatomic Pathology', '??? ??????? ????????', 'Tissue and cell analysis', '????? ??????? ????????', 'medical_services', 32, 'Diagnostic', true, false),
('Nuclear Medicine', '???? ??????', 'Radioactive substances for diagnosis and treatment', '?????? ?????? ??????? ???????', 'medical_services', 33, 'Diagnostic', true, false),

-- Other specialties
('Anesthesiology', '???????', 'Anesthesia and pain management', '??????? ?????? ?????', 'anesthesiology', 34, 'Medical', true, false),
('Emergency Medicine', '?? ???????', 'Immediate medical care for acute conditions', '????? ???? ????? ??????? ??????', 'emergency_medical_services', 35, 'Medical', true, false),
('Family Medicine', '???? ???????', 'Comprehensive healthcare for families', '????? ???? ????? ????????', 'family_restroom', 36, 'Medical', true, false),
('Preventive Medicine', '???? ???????', 'Disease prevention and health promotion', '??????? ?? ??????? ?????? ?????', 'medical_services', 37, 'Medical', true, false),
('Sports Medicine', '???? ???????', 'Sports injuries and performance', '?????? ???????? ???????', 'sports', 38, 'Medical', true, false),
('Occupational Medicine', '???? ??????', 'Workplace health and safety', '????? ???????? ?? ???? ?????', 'medical_services', 39, 'Medical', true, false),
('Physical Medicine and Rehabilitation', '???? ??????? ????????', 'Physical therapy and rehabilitation', '?????? ??????? ????????', 'medical_services', 40, 'Medical', true, false),
('Medical Genetics', '???? ???????', 'Genetic disorders and counseling', '?????????? ???????? ??????????', 'medical_services', 41, 'Medical', true, false),
('Palliative Care', '??????? ?????????', 'Symptom relief for serious illnesses', '????? ??????? ??????? ???????', 'medical_services', 42, 'Medical', true, false),
('Sleep Medicine', '?? ?????', 'Sleep disorders and breathing problems', '???????? ????? ?????? ??????', 'medical_services', 43, 'Medical', true, false),

-- Dental specialties (if applicable)
('Dentistry', '?? ???????', 'Oral health and dental care', '????? ??????? ?????? ???????', 'medical_services', 44, 'Medical', true, false),
('Oral Surgery', '????? ????', 'Surgical procedures in the mouth', '????????? ???????? ?? ????', 'surgery', 45, 'Surgical', true, false),
('Orthodontics', '????? ???????', 'Teeth and jaw alignment', '?????? ??????? ?????', 'medical_services', 46, 'Medical', true, false),
('Periodontics', '????? ?????', 'Gum disease treatment', '???? ????? ?????', 'medical_services', 47, 'Medical', true, false),
('Endodontics', '???? ???? ?????', 'Root canal therapy', '???? ???? ?????', 'medical_services', 48, 'Medical', true, false),

-- Mental Health specialties
('Clinical Psychology', '??? ????? ???????', 'Diagnosis and treatment of mental disorders', '????? ????? ?????????? ???????', 'psychology', 49, 'Medical', true, false),
('Counseling Psychology', '??? ????? ????????', 'Mental health counseling', '??????? ??????', 'psychology', 50, 'Medical', true, false),
('Child and Adolescent Psychiatry', '?? ??? ??????? ??????????', 'Mental health for children and teens', '????? ??????? ??????? ??????????', 'psychology', 51, 'Medical', true, false),
('Addiction Psychiatry', '?? ???????', 'Substance abuse treatment', '???? ????? ??????? ??????', 'psychology', 52, 'Medical', true, false),

-- Specialized care
('Autism Spectrum Disorder', '?????? ??? ??????', 'Autism diagnosis and treatment', '????? ????? ??????', 'medical_services', 53, 'Medical', true, false),
('Developmental Pediatrics', '?? ????? ???????', 'Child development and delays', '??? ????? ??????????', 'child_care', 54, 'Medical', true, false),
('Neurodevelopmental Disorders', '???????? ????? ??????', 'ADHD, learning disabilities, etc.', '?????? ??? ????????? ?????? ??????? ???', 'medical_services', 55, 'Medical', true, false),
('Epilepsy', '?????', 'Seizure disorders', '???????? ???????', 'neurology', 56, 'Medical', true, false),
('Stroke Medicine', '?? ?????? ????????', 'Stroke prevention and treatment', '??????? ?? ?????? ???????? ???????', 'neurology', 57, 'Medical', true, false),
('Pain Management', '????? ?????', 'Chronic pain treatment', '???? ????? ??????', 'medical_services', 58, 'Medical', true, false);
...
-- All functions follow the same pattern for automatic updated_at timestamp management

-- Function to update prescription_items updated_at timestamp
...
-- Function to update vital_signs updated_at timestamp
...
-- Function to update notification_settings updated_at timestamp
...
-- Function to update autism_assessments updated_at timestamp
CREATE OR REPLACE FUNCTION update_autism_assessments_updated_at()
RETURNS TRIGGER AS $$
BEGIN
  NEW.updated_at = NOW();
  RETURN NEW;
...
-- Function to update bug_reports updated_at timestamp
...
CREATE TABLE IF NOT EXISTS appointments (
  ...
  clinic_id UUID REFERENCES clinics(id) ON DELETE SET NULL,
  prescription_id UUID,  -- Will add FK constraint after prescriptions table is created
...
-- ??????????????????????????????????????????????????????????????????????????????
-- ADD DEFERRED FK CONSTRAINTS FOR CIRCULAR DEPENDENCY
-- Both tables now exist, so we can safely add FK relationships in both directions
-- ??????????????????????????????????????????????????????????????????????????????

-- Add FK from prescriptions to appointments
ALTER TABLE prescriptions
ADD CONSTRAINT fk_prescriptions_appointment_id
FOREIGN KEY (appointment_id) REFERENCES appointments(id) ON DELETE SET NULL;

-- Add FK from appointments to prescriptions
ALTER TABLE appointments
ADD CONSTRAINT fk_appointments_prescription_id
...
CREATE TABLE IF NOT EXISTS video_sessions (
  ...
  -- Session Status
  status video_session_status DEFAULT 'scheduled' CHECK (status IN ('scheduled', 'active', 'completed', 'cancelled', 'no_show')),
...
-- ????????????????????????????????????????????????????????????????????????????
-- Subscription Codes Table (Moved Below)
-- ????????????????????????????????????????????????????????????????????????????
...
CREATE TABLE IF NOT EXISTS subscription_codes (
  ...
  type subscription_type NOT NULL CHECK (type IN ('free', 'basic', 'professional', 'enterprise', 'custom', 'trial')),
...
CREATE POLICY "Clinic staff can create invoice items"
  ...
  WITH CHECK (
    invoice_id IN (
      ...
      WHERE clinic_id IN (
        SELECT clinic_id FROM clinic_staff WHERE user_id = auth.uid()
        AND role IN ('admin', 'manager', 'receptionist', 'lab_technician')
      )
    )
  );
...
CREATE POLICY "Clinic staff can create inventory transactions"
  ...
  WITH CHECK (
    clinic_id IN (
      SELECT clinic_id FROM clinic_staff WHERE user_id = auth.uid()
      AND role IN ('admin', 'manager', 'lab_technician', 'nurse')
    )
  );
...
-- Note: update_notification_settings_updated_at() function is defined earlier
-- Create trigger for automatic timestamp update
...
-- RLS Policies (Disabled - requires Supabase auth functions)
...
-- Grant permissions (Disabled - requires Supabase authenticated role)
