...
/// Employee Patients Screen
class EmployeePatientsScreen extends StatefulWidget {
  const EmployeePatientsScreen({super.key});

  @override
  State<EmployeePatientsScreen> createState() => _EmployeePatientsScreenState();
}

class _EmployeePatientsScreenState extends State<EmployeePatientsScreen> {
  @override
