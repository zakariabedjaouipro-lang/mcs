...
/// Employee Lab Results Screen
class EmployeeLabResultsScreen extends StatefulWidget {
  const EmployeeLabResultsScreen({super.key});

  @override
  State<EmployeeLabResultsScreen> createState() =>
      _EmployeeLabResultsScreenState();
}

class _EmployeeLabResultsScreenState extends State<EmployeeLabResultsScreen> {
  @override
