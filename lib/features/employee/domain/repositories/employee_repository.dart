...
abstract class EmployeeRepository {
  ...
  Future<Either<Failure, EmployeeModel>> updateEmployeeProfile(EmployeeModel profile);
  ...
  Future<Either<Failure, void>> registerPatient(Map<String, dynamic> patientData);
  Future<Either<Failure, void>> updatePatient(String patientId, Map<String, dynamic> patientData);
  ...
  Future<Either<Failure, AppointmentModel>> getAppointmentDetails(String appointmentId);
  Future<Either<Failure, void>> bookAppointment(Map<String, dynamic> appointmentData);
  ...
  Future<Either<Failure, void>> recordVitalSigns(String patientId, Map<String, dynamic> vitalSigns);
  Future<Either<Failure, Map<String, dynamic>>> getPatientVitalSigns(String patientId);
  
  // Lab Results Management (Lab Technician)
  Future<Either<Failure, void>> uploadLabResult(Map<String, dynamic> labResult);
  Future<Either<Failure, List<Map<String, dynamic>>>> getLabResults(String patientId);
  Future<Either<Failure, void>> updateLabResult(String resultId, Map<String, dynamic> resultData);
  ...
  Future<Either<Failure, void>> updateInventoryItem(String itemId, Map<String, dynamic> itemData);
  Future<Either<Failure, void>> deleteInventoryItem(String itemId);
  Future<Either<Failure, void>> recordInventoryTransaction(Map<String, dynamic> transactionData);
  ...
  Future<Either<Failure, void>> updateInvoice(String invoiceId, Map<String, dynamic> invoiceData);
  Future<Either<Failure, void> processPayment(String invoiceId, Map<String, dynamic> paymentData);
  
  // Statistics
  Future<Either<Failure, Map<String, dynamic>>> getDashboardStats();
  
  // Notifications
  Future<Either<Failure, void>> sendNotificationToPatient(String patientId, String title, String body);
}