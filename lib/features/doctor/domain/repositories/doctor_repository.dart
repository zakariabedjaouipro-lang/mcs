...
abstract class DoctorRepository {
  ...
  Future<Either<Failure, void>> rejectAppointment(String appointmentId, String reason);
  Future<Either<Failure, void>> cancelAppointment(String appointmentId, String reason);
  Future<Either<Failure, void>> completeAppointment(String appointmentId, Map<String, dynamic> notes);
  Future<Either<Failure, void>> rescheduleAppointment(String appointmentId, DateTime newDateTime);
  
  // Prescription Management
  Future<Either<Failure, void>> createPrescription(PrescriptionModel prescription);
  Future<Either<Failure, List<PrescriptionModel>>> getPrescriptions(String patientId);
  Future<Either<Failure, PrescriptionModel>> getPrescriptionDetails(String prescriptionId);
  Future<Either<Failure, void>> updatePrescription(String prescriptionId, PrescriptionModel prescription);
  ...
  Future<Either<Failure, String>> generateRemoteSessionToken(String appointmentId);
  ...
  Future<Either<Failure, void>> approveRemoteSessionRequest(String appointmentId);
  Future<Either<Failure, void>> rejectRemoteSessionRequest(String appointmentId, String reason);
}