...
class _SuperAdminDashboardViewState extends State<_SuperAdminDashboardView>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(isArabic ? 'لوحة تحكم المسؤول الأعلى' : 'Super Admin Dashboard'),
        elevation: 0,
        centerTitle: true,
      ),
      body: BlocBuilder<AdminBloc, AdminState>(
        builder: (context, state) {
          // عرض رسالة تحميل في البداية
          ...
          children: [
            ...
            GridView.count(
              ...
              children: [
                ...
                _buildStatCard(
                  context,
                  label: isArabic ? 'الاشتراكات النشطة' : 'Active Subs',
                ...
                _buildStatCard(
                  context,
                  label: isArabic ? 'الاشتراكات التجريبية' : 'Trial Subs',
                  value: state.trialSubscriptions.toString(),
                  icon: Icons.schedule,
                  color: Colors.purple,
                ),
                _buildStatCard(
                  context,
                  label: isArabic ? 'الاشتراكات منتهية' : 'Expired',
                  value: state.expiredSubscriptions.toString(),
        ...
        return Center(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              Text(
                isArabic ? 'لا توجد بيانات للأطباء' : 'No doctors found',
              ),
            ],
          ),
        );
        ...
        return Center(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              Text(
                isArabic ? 'لا توجد بيانات للمرضى' : 'No patients found',
              ),
            ],
          ),
        );
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    isArabic
                        ? 'طلبات معلقة: ${state.count}'
                        : 'Pending Approvals: ${state.count}',
