    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildSection(
            context.translateSafe('system'),
            [
              _buildListTile(
                context,
                Icons.business,
                context.translateSafe('manage_clinics'),
                () {
              ...
              _buildListTile(
                context,
                Icons.people,
                context.translateSafe('manage_users'),
                () {
              ...
              _buildListTile(
                ...
                context.translateSafe('manage_doctors'),
                () {
              ...
              _buildListTile(
                context,
                Icons.work,
                context.translateSafe('manage_employees'),
                () {
