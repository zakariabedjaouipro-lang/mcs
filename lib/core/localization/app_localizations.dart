...
class AppLocalizations {
  ...
  String get verifyOtp =>
      locale.languageCode == 'ar' ? 'التحقق من الرمز' : 'Verify OTP';
  ...
  // ── Validation ────────────────────────────────────────────
  String get requiredField => locale.languageCode == 'ar'
      ? 'هذا الحقل مطلوب'
      : 'This field is required';
  String get invalidEmail => locale.languageCode == 'ar'
      ? 'البريد الإلكتروني غير صالح'
      : 'Invalid email address';
  String get invalidPhone => locale.languageCode == 'ar'
      ? 'رقم الهاتف غير صالح'
  ...
  String get invalidOtp =>
      locale.languageCode == 'ar' ? 'رمز التحقق غير صالح' : 'Invalid OTP code';
  String get otpExpired => locale.languageCode == 'ar'
  ...
  String get loginSuccess => locale.languageCode == 'ar'
      ...
      : 'Login successful';
  String get registerSuccess => locale.languageCode == 'ar'
      ? 'تم إنشاء الحساب بنجاح'
      : 'Registration successful';
  String get logoutSuccess => locale.languageCode == 'ar'
      ? 'تم تسجيل الخروج بنجاح'
      : 'Logout successful';
  String get passwordResetSent => locale.languageCode == 'ar'
      ? 'تم إرسال رابط إعادة تعيين كلمة المرور'
      : 'Password reset link sent';
  String get passwordChanged => locale.languageCode == 'ar'
      ? 'تم تغيير كلمة المرور بنجاح'
      : 'Password changed successfully';
  String get otpSent => locale.languageCode == 'ar'
      ? 'تم إرسال رمز التحقق'
      : 'OTP sent successfully';
  String get otpVerified => locale.languageCode == 'ar'
      ? 'تم التحقق من الرمز بنجاح'
      : 'OTP verified successfully';

  // ── Theme ────────────────────────────────────────────────
  String get lightTheme =>
      locale.languageCode == 'ar' ? 'الوضع الفاتح' : 'Light Theme';
  String get darkTheme =>
      locale.languageCode == 'ar' ? 'الوضع الداكن' : 'Dark Theme';
  ...
  String get learnMore =>
      locale.languageCode == 'ar' ? 'اعرف المزيد' : 'Learn More';
  ...
  String get terms =>
      locale.languageCode == 'ar' ? 'شروط الاستخدام' : 'Terms of Service';
